...
export default function Create() {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Post a Announcement" />
                ...
                <Card>
                    <form onSubmit={handleSubmit}>
                        <div className="flex flex-col items-center justify-center gap-2 text-center sm:flex-row sm:gap-3">
                            ...
                            <h1 className="text-2xl font-bold text-gray-900 sm:text-3xl dark:text-gray-100">Post an Announcement</h1>
                        </div>
                        <CardContent className="space-y-6 p-6">
                            ...
                            <div className="grid gap-2">
                                <Label htmlFor="meeting_date" className="font-medium text-gray-800 dark:text-gray-200">
                                    Date of Meeting
                                </Label>
                                ...
                                <Input
                                    ...
                                    required
                                    className="border border-gray-300 bg-white text-gray-900 focus:border-blue-500 focus:ring-2 focus:ring-blue-500 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-100 dark:focus:border-blue-400 dark:focus:ring-blue-400"
                                />

                                {errors.meeting_date && <span className="text-sm text-red-500 dark:text-red-400">{errors.meeting_date}</span>}
                            </div>
                        </CardContent>
